...
For EACH finding:
1. Re-read the code path that triggered the finding
2. Search for sanitization, middleware, or framework protections upstream of the sink
...
If a reference file cannot be read, proceed using built-in knowledge for that category:
